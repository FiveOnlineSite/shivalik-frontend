        ...
        <div className='row justify-content-center align-items-center'>
          <div className='col-lg-8 text-center'>
            <div className={`${homestyles.keyFeatureBox} pt-5 pb-5 pl-5 pr-5 mt-5 mb-5`}>
              ...
              <p>Each development is a reflection of our people-first approach and commitment to purposeful design. Because for us, building isnâ€™t just about structures; itâ€™s about shaping lives and nurturing communities </p>
              <div className='row'>
                <div className='col-lg-3 col-6 text-center'>
                  <img
                    src='images/quality-icon.svg'
                    className='mb-3'
                    alt='Lasting quality icon'
                    width='56'
                    height='56'
                    loading='lazy'
                    decoding='async'
                ...
                <div className='col-lg-3 col-6 text-center'>
                  <img
                    src='images/integrity-icon.svg'
                    className='mb-3'
                    alt='Ethical approach icon'
                    width='56'
                    height='56'
                    loading='lazy'
                    decoding='async'
                ...
                <div className='col-lg-3 col-6 text-center'>
                  <img
                    src='images/legacy-icon.svg'
                    className='mb-3'
                    alt='Legacy driven icon'
                    width='56'
                    height='56'
                    loading='lazy'
                    decoding='async'
