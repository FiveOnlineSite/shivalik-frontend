...
const AddCSRBanners = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${apiUrl}/api/csr-banner`, formData, {
        headers: {
      ...
      toast.success("CSR Banner created successfully!");
      
    } catch (error) {
      console.error("Error adding CSR banner:", error);
      setErrorMessage(error.response?.data?.message || "An error occurred");
      toast.error("Failed to create CSR banner");
