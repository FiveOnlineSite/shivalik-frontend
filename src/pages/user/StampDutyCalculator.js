...
import CalculatorBox from '../../components/molecules/CalculatorBox';
import GradientLineTwo from '../../components/atoms/GradientLineTwo';
...
const StampDutyCalculator = () => {
        ...
        const currentPath = location.pathname;
          ...
          useEffect(() => {
            const fetchHomeData = async () => {
              ...
              const [ metaRes, stampDutyRes] =
                await Promise.allSettled([
          axios.get(`${apiUrl}/api/meta-data/by-page${currentPath}`),
           axios.get(`${apiUrl}/api/stamp-duty`),
                ]);
              ...
              if (stampDutyRes.status === "fulfilled") {
                setStampDuty(stampDutyRes.value.data.StampDuty || null);
              }
  ...
  return (
    ...
    <GradientLineTwo />
    <CalculatorBox stampDuty={stampDuty} />
    <div class="stap-sec">
